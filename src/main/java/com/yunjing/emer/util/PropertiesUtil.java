...
public class PropertiesUtil {
    ...
    public void writeProperty(String key, String value) {
        ...
        Properties p = new Properties();
        try {
            String filePath = PropertiesUtil.class.getClassLoader().getResource(properiesName).toURI().getPath();
...
//            os = new FileOutputStream(PropertiesUtil.class.getClassLoader().getResource(properiesName).getFile());
   ...
   public static void main(String[] args) {
        ...
        System.out.println(p.readProperty("myUtils2"));
        PropertiesUtil q = new PropertiesUtil("tree.properties");
        q.writeProperty("myUtils2", "wang");
//        System.exit(0);
    }
