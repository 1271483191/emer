        ...
        function SaveData(msg,companyid,id) {
            ...
            $.ajax({
                ...
                data: {companyId:companyId,name:name,province:province,city:city,county:county,socialId:socialId,location:location,principal:principal,phone:phone,
                    inDay:inDay,outDay:outDay,saveDay:saveDay,websiteId:websiteId,flourExp:flourExp,riceExp:riceExp,oilExp:oilExp,elseExp:elseExp,flourReal:flourReal,riceReal:riceReal,oilReal:oilReal,elseReal:elseReal,state:status},
                async:false,
                success: function(data){
                    // initnewAttributeTable();
                },
