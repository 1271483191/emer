...
//style the message box
        ...
        function SaveData(msg,companyid,id) {
            ...
            var outDay = msg[7];
            var saveDay = msg[8];
            var transportDay = msg[9];
            var carNum = msg[10];
            var transportDayReal = msg[11];
            var status;
            if(msg[12] == "未选择"){
                status = 0;
            }
            ...
            $.ajax({
                ...
                data: {companyId:companyId,name:name,province:province,city:city,county:county,socialId:socialId,location:location,principal:principal,phone:phone,
                    inDay:inDay,outDay:outDay,saveDay:saveDay,storeageId:storeageId,transportDay:transportDay,carNum:carNum,transportDayReal:transportDayReal,state:status},
                async:false,
                success: function(data){
                    // initnewAttributeTable();
                },
